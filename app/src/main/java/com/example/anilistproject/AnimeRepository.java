...
public class AnimeRepository {
    ...
    public LiveData<PagedList<Anime>> getTopAll() {
        refreshAnimeList();
        ...
        animeList = new LivePagedListBuilder<>(
                mAnimeDao.getAll(), /* page size */ conf).build();
        return animeList;
    }

    public LiveData<PagedList<Anime>> getTopAnimes() {
        refreshAnimeList();
        PagedList.Config conf = new PagedList.Config.Builder().setEnablePlaceholders(true).setInitialLoadSizeHint(100).setPageSize(10).build();
        animeList = new LivePagedListBuilder<>(
    ...
    public LiveData<PagedList<Anime>> getTopMovies() {
        refreshAnimeList();
        PagedList.Config conf = new PagedList.Config.Builder().setEnablePlaceholders(true).setInitialLoadSizeHint(100).setPageSize(10).build();
        animeList = new LivePagedListBuilder<>(
                mAnimeDao.getAllMovies(), /* page size */ conf).build();
        return animeList;
    }
